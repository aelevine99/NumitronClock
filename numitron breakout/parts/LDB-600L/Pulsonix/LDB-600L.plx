...
(library Library_1
	...
	(patternDef "LDB600L" (originalName "LDB600L")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 7.620, -13.840) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt 17.77 -29.74) (pt -2.53 -29.74) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.53 -29.74) (pt -2.53 2.06) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.53 2.06) (pt 17.77 2.06) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 17.77 2.06) (pt 17.77 -29.74) (width 0.025))
		)
	...
	(symbolDef "LDB-600L" (originalName "LDB-600L")
		...
		(pin (pinNum 5) (pt 1400 mils -400 mils) (rotation 180) (pinLength 200 mils) (pinDisplay (dispPinName true)) (pinName (text (pt 1170 mils -425 mils) (rotation 0]) (justify "Right") (textStyleRef "Normal"))
		))
		(pin (pinNum 6) (pt 1400 mils -300 mils) (rotation 180) (pinLength 200 mils) (pinDisplay (dispPinName true)) (pinName (text (pt 1170 mils -325 mils) (rotation 0]) (justify "Right") (textStyleRef "Normal"))
		))
	...
	(compDef "LDB-600L" (originalName "LDB-600L") (compHeader (numPins 9) (numParts 1) (refDesPrefix PS)
		...
		(compPin "21" (pinName "PWM DIM") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.meanwell.com/Upload/PDF/LDB-L/LDB-L-SPEC.PDF")
		(attr "<Component Height>" "12.25")
		(attr "<STEP Filename>" "LDB-600L.stp")
